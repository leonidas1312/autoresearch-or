...
BENCHMARK_SOLVERS: dict[str, SolverSpec] = {
    ...
    "lin318": SolverSpec(
        solver_name="lin318_geometric_first",
        start_order="time_boxed",
        anchor_order=("max_y", "far", "min_y", "max_x"),
        ils_enabled=False,
    ),
    "rat783": SolverSpec(
        solver_name="rat783_geometric_first",
        start_order="time_boxed",
        anchor_order=("max_x", "max_y", "min_x", "far"),
        ils_enabled=False,
    ),
    "pcb442": SolverSpec(
        solver_name="pcb442_geometric_first",
        start_order="time_boxed",
        anchor_order=("far", "max_x", "max_y", "min_x"),
        ils_enabled=False,
    ),
    "pr1002": SolverSpec(
        solver_name="pr1002_geometric_pair",
        start_order="time_boxed",
        anchor_order=("max_x", "min_y"),
        ils_enabled=False,
    ),
}
